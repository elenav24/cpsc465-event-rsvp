...
class PotluckItem(Base):
    ...
    claims: Mapped[list["PotluckClaim"]] = relationship(
        "PotluckClaim", back_populates="item", cascade="all, delete-orphan"
    )
...
class PotluckClaim(Base):
    ...
    item_id: Mapped[int] = mapped_column(
        Integer,
        ForeignKey("potluck_items.id", ondelete="CASCADE"),
        nullable=False,
        index=True,
    )
