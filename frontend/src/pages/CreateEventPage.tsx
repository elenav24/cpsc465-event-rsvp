...
const TEMPLATE_IMAGES: TemplateImage[] = [
  ...
  },
  {
    id: "game-night",
    label: "Game Night",
    url: "https://images.unsplash.com/photo-1610890716171-6b1bb98ffd09?w=600&q=80",
  },
  {
    id: "picnic",
    label: "Park Picnic",
    url: "https://images.unsplash.com/photo-1526401485004-46910ecc8e51?w=600&q=80",
  },
  {
    id: "brunch",
    label: "Sunday Brunch",
    url: "https://images.unsplash.com/photo-1504754524776-8f4f37790ca0?w=600&q=80",
  },
  {
    id: "watch-party",
    label: "Watch Party",
    url: "https://images.unsplash.com/photo-1522869635100-9f4c5e86aa37?w=600&q=80",
  },
  {
    id: "hike",
    label: "Group Hike",
  ...
  },
  {
    id: "trivia-night",
    label: "Trivia Night",
    url: "https://images.unsplash.com/photo-1606326608606-aa0b62935f2b?w=600&q=80",
  },
  {
    id: "yoga-wellness",
...
export default function CreateEventPage() {
  ...
  const tpl = (location.state as { template?: TemplatePrefill } | null)
    ?.template;
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (flyerFile) {
        ...
        formData.append(
          "flyer",
          new File([blob], `flyer.${ext}`, { type: blob.type }),
        );
      }
  ...
  return (
    <div className="pt-[calc(var(--nav-height)+2.5rem)] px-8 pb-16 max-w-[1000px] mx-auto flex-1 w-full max-[640px]:px-4">
      {/* ── Page heading ── */}
      ...
      {tpl && (
        ...
        >
          ...
          <span>
            Using the <strong>{tpl.title}</strong> template — title and
            description are pre-filled.
            {autoImageUrl &&
              " A matching cover image has been selected for you."}
          </span>
        </div>
      )}
        ...
        <div className="grid grid-cols-2 gap-6 mb-6 max-[700px]:grid-cols-1 items-stretch">
          ...
          <div style={CARD_STYLE} className="p-6">
            <SectionHeader
              step={1}
              label="The Basics"
              icon={<FiAlignLeft size={15} color="#6C3483" />}
            />
            ...
            <div className="grid grid-cols-2 gap-2 mb-4">
              <div className="relative">
                <FiCalendar
                  size={13}
                  className="absolute left-3 top-1/2 -translate-y-1/2 text-[#a78bfa] pointer-events-none"
                />
                <input
          ...
          <div style={CARD_STYLE} className="p-6 flex flex-col">
            <SectionHeader
              step={2}
              label="Cover Image"
              icon={<FiImage size={15} color="#6C3483" />}
            />
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-[0.72rem] font-bold uppercase tracking-wider text-[#a78bfa]">
                or pick a template image
              </span>
              <div className="flex-1 h-px" style={{ background: "#e9d5ff" }} />
            </div>
              ...
              {TEMPLATE_IMAGES.map((img) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <span className="text-white text-[0.6rem] font-semibold leading-tight">
                        {img.label}
                      </span>
                    </div>
                    {/* Selected checkmark */}
