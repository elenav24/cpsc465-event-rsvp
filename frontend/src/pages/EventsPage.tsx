  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div>
            <div className="text-[0.65rem] font-bold uppercase tracking-widest text-[#be185d] mb-1">
              RSVP
            </div>
            <h2 className="font-display text-[1.25rem] text-text-dark leading-tight">
              {event.title}
            </h2>
            {event.start_dt && (
        ...
        <div className="p-5">
          {loading ? (
            ...
            <>
              <div className="text-[0.8rem] font-semibold text-text-dark mb-3">
                Will you be there?
              </div>
              ...
              {status === "yes" && (
                <div className="mb-4 p-3 rounded-xl bg-[#f0fdf4] border border-[#86efac]">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[1rem] font-bold text-[#15803d] w-5 text-center">
                      {guestCount}
                    </span>
                    <button
                    ...
                    <span className="text-[0.75rem] text-[#15803d]">
                      additional guests
                    </span>
                  </div>
                </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="font-display text-[1.2rem] text-text-dark mb-2">
          Delete Event?
        </h2>
        <p className="text-[0.85rem] text-text-muted mb-5 leading-relaxed">
          <strong className="text-text-dark">"{event.title}"</strong> and all
          its data will be permanently removed. This can't be undone.
        </p>
        {error && (
          <div className="text-[0.78rem] text-red-600 mb-3 bg-red-50 rounded-lg px-3 py-2 border border-red-200">
            {error}
    ...
    >
      ...
      >
        <div
          ...
          style={{
            height: 140,
            background: "linear-gradient(135deg, #fce7f3 0%, #ede9ff 100%)",
          }}
        >
          {event.flyer_url ? (
            <img
            ...
            <div className="w-full h-full flex items-center justify-center">
              <div className="text-center px-4 select-none">
                <div className="font-display text-[0.95rem] leading-snug text-text-dark">
                  Events are <span className="text-pink">better</span>
                  <br />
...
export default function EventsPage() {
  ...
  const hostingCount = events.filter(
    (ev) => ev.host_id === myId || ev.host_id === myDbId,
  ).length;
    ...
    <>
      ...
      {deleteTarget && (
        <DeleteModal
          ...
          onDeleted={() => {
            setEvents((prev) =>
              prev.filter((e) => e.uuid !== deleteTarget.uuid),
            );
      ...
      <div className="pt-[calc(var(--nav-height)+2.5rem)] px-12 pb-16 flex-1 w-full max-[640px]:pt-6 max-[640px]:px-4">
        ...
        {error && (
          <div
            className="rounded-xl p-4 mb-6 text-[0.85rem] flex items-center gap-2"
            style={{
              background: "#fff0f0",
              border: "1px solid #fca5a5",
              color: "#dc2626",
        ...
        {!loading && !error && events.length === 0 && (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h2 className="font-display text-[1.5rem] text-text-dark mb-2">
              No events yet
            </h2>
