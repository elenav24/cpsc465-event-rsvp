...
function TwinkleStar({
  ...
  return (
    <svg
      ...
      fill="none"
      style={{
        animation: `star-twinkle-real ${duration} ease-in-out infinite ${delay}`,
      }}
    >
      <line
        x1={h}
  ...
  return (
    <div className="relative w-full flex-1 flex flex-col overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(252,206,232,0.4) 0%, rgba(233,212,255,0.4) 100%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(233,212,255,0.3) 0%, rgba(252,206,232,0.3) 100%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(253,165,213,0.2) 0%, rgba(218,178,255,0.2) 100%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(255,240,133,0.2) 0%, rgba(252,206,232,0.2) 100%)",
        }}
      />
      ...
      <div className="relative z-10 flex-1 flex flex-col md:flex-row items-center md:justify-between w-full pt-32 pb-16 px-[10%] md:pt-0 md:pb-0 md:pl-16 lg:pl-24 xl:pl-40 md:pr-0">
        ...
        <div className="flex flex-col justify-center items-center md:items-start gap-8 w-full md:w-1/2 text-center md:text-left">
          ...
          <div
            ...
            style={{
              ...
              fontSize: "clamp(3.5rem, 5.56vw, 80px)",
            }}
          >
          ...
          <p
            ...
            style={{
              ...
              fontSize: "clamp(1.15rem, 1.39vw, 20px)",
            }}
          >
            The RSVP tool built for potlucks, watch parties, and group hangs.{" "}
            <strong className="font-bold">
              Start hosting <em className="italic">with</em> your friends,
            </strong>{" "}
          ...
          <Link
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.boxShadow = "6px 6px 0px #462749";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.boxShadow = "4px 4px 0px #462749";
            }}
          >
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center pt-14 pb-8 md:py-0">
          ...
          <div
            ...
            style={{ width: "65%", aspectRatio: "4 / 5" }}
          >
            <div
              className="absolute inset-0 rounded-[18px]"
              style={{ boxShadow: "6px 8px 0px #c084b8" }}
            />
            <img
              src={partyImg}
              alt="Party"
          ...
          <div
            ...
            onMouseEnter={(e) => {
              ...
              const shadow = e.currentTarget.querySelector(
                ".card-shadow",
              ) as HTMLDivElement;
