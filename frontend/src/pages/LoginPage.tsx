...
const inputClass =
  "w-full border-[1.5px] border-border rounded-[var(--radius-sm)] px-[14px] py-[11px] font-sans text-[0.95rem] outline-none transition-[border-color] duration-200 mb-4 bg-white text-text-dark focus:border-pink";
const btnPrimary =
  "w-full bg-pink text-white border-none rounded-full py-[14px] font-sans text-[1rem] font-semibold cursor-pointer transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed hover:enabled:bg-accent-dark";
    ...
    <div className="flex-1 flex flex-col pt-[var(--nav-height)] w-full">
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="bg-white rounded-[var(--radius-xl)] border-r border-b border-[#973B69] border-l border-t border-l-[#e8e4ed] border-t-[#e8e4ed] w-full max-w-[480px] px-10 py-12 shadow-[4px_4px_0px_#973B69] max-[480px]:px-5 max-[480px]:py-8">
          ...
          {step === "login" && (
            <>
              <h1 className="font-heading text-[1.9rem] text-center mb-8 text-text-dark">
                Sign in
              </h1>
              ...
              <form onSubmit={handleLogin}>
                <label className="text-[0.88rem] text-[#555] mb-[6px] block">
                  Email address
                </label>
                <input
                ...
                <div className="flex justify-between items-center mb-[6px]">
                  <label className="text-[0.88rem] text-[#555]">
                    Your password
                  </label>
                  <button
                    type="button"
                ...
                {error && (
                  <p className="text-danger text-[0.85rem] mb-4" role="alert">
                    ⚠ {error}
                  </p>
                )}
          ...
          {step === "forgot-request" && (
            <>
              <h1 className="font-heading text-[1.9rem] text-center mb-3 text-text-dark">
                Reset password
              </h1>
