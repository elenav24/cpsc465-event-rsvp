...
function InviteCardVisual() {
  return (
    ...
    >
      <img
        src={gatherYourPeopleImg}
        alt="Gather your people"
        className="w-full h-full object-contain"
      />
    </div>
  );
...
const STEPS: Step[] = [
  {
    ...
    title: "Set the Vibe",
    description:
      "Start with a designer-curated template that sets the mood, or build your vision from scratch. Whether it's an intimate dinner or a rooftop bash, we give you the perfect foundation to spark inspiration.",
  ...
  },
  {
    ...
    description:
      "Share one link and let the magic happen. Manage RSVPs and guest preferences in a single, beautiful dashboard.",
    icon: <HiUserGroup />,
  ...
  },
  {
    ...
    description:
      "Keep everyone in the loop with interactive polls, potluck signups, and assigned tasks. Whether you're picking a date or coordinating who brings the drinks, everyone stays aligned in one collaborative space.",
  ...
  },
  {
    ...
    description:
      "With the details handled and the guest list synced, you're free to actually enjoy your own party. We take care of the admin so you can focus on the people.",
    icon: <BiParty />,
    ...
    <section className="container text-center relative pt-4 pb-20">
      <div className="relative z-10">
        ...
        <p className="font-sans text-lg text-text-dark max-w-2xl mx-auto mb-10 leading-relaxed max-w-130">
          Skip the group chat chaos. Cohosted makes organizing events effortless
          and collaborative in four simple moves.
        </p>
      </div>
    </section>
  );
    ...
    <section className="container mt-20 text-center">
      <div className="max-w-3xl mx-auto">
        <div className="bg-pink-dark text-white rounded-[48px] py-14 px-10 relative overflow-hidden shadow-[var(--shadow-lg)]">
          ...
          />
          <h2 className="font-display text-5xl uppercase relative z-10 leading-none tracking-wider mb-5">
            Ready to Cohost?
          </h2>
          <p className="font-sans text-base mb-8 max-w-[50%] mx-auto text-pink-pale relative z-10 leading-relaxed">
            Join thousands of hosts who have traded planning anxiety for party
            anticipation.
          </p>
