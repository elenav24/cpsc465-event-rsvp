  ...
  return (
    ...
    >
      ...
      {event.start_dt && (
        ...
        >
          {new Date(event.start_dt).toLocaleDateString("en-US", {
            month: "short",
            day: "numeric",
            year: "numeric",
            hour: "numeric",
...
export default function ProfilePage() {
  ...
  const initialTab =
    searchParams.get("tab") === "reminders" ? "reminders" : "profile";
    ...
    >
      ...
      {tab === "reminders" && (
        <div>
          ...
          >
            Get an email reminder before your events start. Toggle the times you
            want for each event.
          </p>
          {eventsLoading && (
          ...
          {events.map((ev) => (
            <EventReminderRow key={ev.uuid} event={ev} />
          ))}
        </div>
      )}
    </div>
