...
export function regenerateInvite(eventUuid: string): Promise<EventOut> {
  return apiFetch("events", `/${eventUuid}/invite/regenerate`, {
    method: "POST",
  });
}
...
export function removeMember(eventUuid: string, userId: string): Promise<void> {
  return apiFetch("events", `/${eventUuid}/members/${userId}`, {
    method: "DELETE",
  });
}
...
export function closePoll(eventUuid: string, pollId: number): Promise<PollOut> {
  return apiFetch("events", `/${eventUuid}/polls/${pollId}/close`, {
    method: "POST",
  });
}

export function deletePoll(eventUuid: string, pollId: number): Promise<void> {
  return apiFetch("events", `/${eventUuid}/polls/${pollId}`, {
    method: "DELETE",
  });
}
...
export function deletePotluckItem(
  eventUuid: string,
  itemId: number,
): Promise<void> {
  return apiFetch("events", `/${eventUuid}/potluck/${itemId}`, {
...
export function claimPotluckItem(
  eventUuid: string,
  itemId: number,
): Promise<PotluckItemOut> {
  return apiFetch("events", `/${eventUuid}/potluck/${itemId}/claim`, {
    method: "POST",
  });
}

export function unclaimPotluckItem(
  eventUuid: string,
  itemId: number,
): Promise<void> {
  return apiFetch("events", `/${eventUuid}/potluck/${itemId}/claim`, {
...
export function deleteReminder(
  ...
  return apiFetch("events", `/${eventUuid}/reminders/${reminderId}`, {
    method: "DELETE",
  });
}
